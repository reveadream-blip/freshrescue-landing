...
const translations = {
 it: {
    ...
    geoDenied: "Attiva manualmente la geolocalizzazione sul tuo telefono se non vedi le offerte vicino a te.",
    geoRetry: "Riprova ad attivare la geolocalizzazione",
    home: "Home",
    explore: "Esplora",
    ...
    trialDesc: "Approfitta di questa offerta per aumentare la tua visibilità locale.",
    ...
    discountPrice: "Prezzo Flash",
    flashPrice: "Prezzo Flash",
    ...
    swissCitiesHint: "Suggerimenti città",
    // Categories & Options
    bakery: "Panetteria",
    fruits: "Frutta",
    vegetables: "Verdura",
    ...
    termsSection1Content:
      "FreshRescue fornisce una piattaforma anti-spreco che consente alle attività commerciali di vendere le eccedenze alimentari a prezzi ridotti. L'app facilita la scoperta delle offerte vicino all'utente.",
    ...
    termsCookiesAnalyticsContent: "Google Analytics 4 ci aiuta a capire come il sito viene utilizzato, in modo anonimo (IP anonimizzato). Conservazione: fino a 14 mesi. I dati vengono trasferiti a Google LLC (Stati Uniti) con clausole contrattuali tipo e Consent Mode v2. Disattivato di default fino al tuo consenso.",
    termsCookiesMarketingTitle: "Marketing",
    termsCookiesMarketingContent: "Attualmente non utilizziamo cookie pubblicitari. La categoria resta disponibile per il futuro e sarà sempre disattivata di default.",
    termsCookiesRightsTitle: "I tuoi diritti",
    termsCookiesRightsContent: "Hai il diritto di accesso, rettifica, cancellazione, opposizione e portabilità dei tuoi dati. Per esercitarli, contatta contact.applimanagement@gmail.com.",
    termsCookiesManageButton: "Modifica le mie scelte cookie",
  ...
  en: {
    ...
    geoDenied: "Please enable geolocation manually on your phone if you don't see offers near you.",
    geoRetry: "Retry enabling geolocation",
    home: "Home",
    explore: "Explore",
    ...
    swissCitiesHint: "City suggestions",
    // Categories & Options
    bakery: "Bakery",
    fruits: "Fruits",
    ...
    termsSection1Content:
      "FreshRescue provides an anti-food-waste platform allowing retailers to sell surplus food at reduced prices. The app helps users find offers nearby.",
    ...
    termsCookiesAnalyticsContent: "Google Analytics 4 helps us understand how the site is used, anonymously (IP anonymized). Retention: up to 14 months. Data is transferred to Google LLC (United States) under standard contractual clauses with Consent Mode v2. Disabled by default until you consent.",
    termsCookiesMarketingTitle: "Marketing",
    termsCookiesMarketingContent: "We do not use advertising cookies today. The category remains available for the future and will always be disabled by default.",
    termsCookiesRightsTitle: "Your rights",
    termsCookiesRightsContent: "You have the right to access, rectify, delete, object to, and port your data. To exercise these rights, contact contact.applimanagement@gmail.com.",
    termsCookiesManageButton: "Manage my cookie choices",
  ...
  fr: {
    ...
    heroSubtitle:
      "FreshRescue relie les commerçants et les consommateurs près de chez eux pour sauver les invendus, réduire le gaspillage et proposer des prix flash justes.",
    ...
    trialDesc: "Profitez de l'offre pour booster votre visibilité locale.",
    ...
    featureGeo: "Carte et offres près de vos clients",
    ...
    geoDenied: "Veuillez activer manuellement la géolocalisation sur votre téléphone si vous ne voyez pas les offres autour de vous.",
    geoRetry: "Relancer la demande de géolocalisation",
    ...
    swissCitiesHint: "Suggestions de villes",
    // Categories & Options
    bakery: "Boulangerie",
    fruits: "Fruits",
    vegetables: "Légumes",
    ...
    termsSection1Content:
      "FreshRescue fournit une plateforme anti-gaspillage permettant aux commerces de détail de vendre leurs surplus alimentaires à prix réduit. L'application facilite la découverte des offres près de l'utilisateur.",
    ...
    termsCookiesTitle: "4. COOKIES ET MESURE D'AUDIENCE",
    termsCookiesIntroContent: "FreshRescue.app utilise des cookies et technologies similaires pour assurer le fonctionnement du site, mémoriser vos préférences et mesurer l'audience via Google Analytics (ID : G-VDSJYFKB65). Conformément au RGPD (UE), votre consentement est requis avant tout dépôt de cookie non essentiel.",
    termsCookiesNecessaryTitle: "Cookies nécessaires",
    termsCookiesNecessaryContent: "Indispensables au fonctionnement du site (sécurité, préférences de langue, consentement cookies). Ne requièrent pas votre consentement.",
    termsCookiesAnalyticsTitle: "Mesure d'audience (Google Analytics)",
    termsCookiesAnalyticsContent: "Google Analytics 4 nous aide à comprendre comment le site est utilisé, de manière anonyme (IP anonymisée). Conservation : jusqu'à 14 mois. Les données sont transférées à Google LLC (États-Unis) avec clauses contractuelles types et Consent Mode v2. Désactivé par défaut jusqu'à votre consentement.",
    termsCookiesMarketingTitle: "Marketing",
    termsCookiesMarketingContent: "Nous n'utilisons pas de cookies publicitaires aujourd'hui. La catégorie reste disponible pour l'avenir et restera toujours désactivée par défaut.",
    termsCookiesRightsTitle: "Vos droits",
    termsCookiesRightsContent: "Vous disposez d'un droit d'accès, de rectification, de suppression, d'opposition et de portabilité de vos données. Pour les exercer, contactez contact.applimanagement@gmail.com.",
    termsCookiesManageButton: "Modifier mes choix cookies",
  ...
  de: {
    ...
    heroSubtitle:
      "FreshRescue verbindet Händler und Kundinnen in der Nähe, rettet Überschüsse, vermeidet Abfall und ermöglicht faire Blitzpreise.",
    ...
    geoDenied: "Bitte aktiviere den Standortzugriff manuell auf deinem Telefon, falls du keine Angebote in deiner Nähe siehst.",
    geoRetry: "Standortzugriff erneut anfragen",
    ...
    discountPrice: "Blitzpreis",
    flashPrice: "Blitzpreis",
    ...
    swissCitiesHint: "Stadtvorschläge",
    // Categories & Options
    bakery: "Bäckerei",
    fruits: "Obst",
    vegetables: "Gemüse",
    ...
    termsSection1Content:
      "FreshRescue ist eine Plattform gegen Lebensmittelverschwendung: Einzelhandel kann Überschüsse zu reduzierten Preisen verkaufen. Die App erleichtert die Suche nach Angeboten in der Nähe.",
    ...
    termsCookiesTitle: "4. COOKIES UND REICHWEITENMESSUNG",
    termsCookiesIntroContent: "FreshRescue.app verwendet Cookies und ähnliche Technologien, um den Betrieb der Website zu gewährleisten, Ihre Einstellungen zu speichern und die Reichweite über Google Analytics (ID: G-VDSJYFKB65) zu messen. Gemäss DSGVO (EU) ist Ihre Zustimmung erforderlich, bevor nicht zwingend erforderliche Cookies gesetzt werden.",
    termsCookiesNecessaryTitle: "Notwendige Cookies",
    termsCookiesNecessaryContent: "Unverzichtbar für den Betrieb der Website (Sicherheit, Spracheinstellungen, Cookie-Einwilligung). Keine Einwilligung erforderlich.",
    termsCookiesAnalyticsTitle: "Reichweitenmessung (Google Analytics)",
    termsCookiesAnalyticsContent: "Google Analytics 4 hilft uns zu verstehen, wie die Website genutzt wird – anonymisiert (IP anonymisiert). Aufbewahrung: bis zu 14 Monate. Die Daten werden an Google LLC (USA) mit Standardvertragsklauseln und Consent Mode v2 übermittelt. Standardmässig deaktiviert bis zu Ihrer Einwilligung.",
    termsCookiesMarketingTitle: "Marketing",
    termsCookiesMarketingContent: "Wir verwenden derzeit keine Werbe-Cookies. Die Kategorie bleibt für die Zukunft verfügbar und bleibt stets standardmässig deaktiviert.",
    termsCookiesRightsTitle: "Ihre Rechte",
    termsCookiesRightsContent: "Sie haben das Recht auf Auskunft, Berichtigung, Löschung, Widerspruch und Datenübertragbarkeit. Kontakt: contact.applimanagement@gmail.com.",
    termsCookiesManageButton: "Meine Cookie-Einstellungen ändern",
  ...
  ru: {
    ...
    geoDenied: "Пожалуйста, включите геолокацию вручную на вашем телефоне, если не видите предложений рядом.",
    geoRetry: "Попробовать снова включить геолокацию",
    ...
    swissCitiesHint: "Подсказки городов",
    // Categories & Options
    bakery: "Выпечка",
    fruits: "Фрукты",
    vegetables: "Овощи",
    ...
    termsCookiesTitle: "4. COOKIE И ИЗМЕРЕНИЕ АУДИТОРИИ",
    termsCookiesIntroContent: "FreshRescue.app использует cookie и аналогичные технологии для обеспечения работы сайта, сохранения ваших настроек и измерения аудитории через Google Analytics (ID: G-VDSJYFKB65). В соответствии с GDPR (ЕС), ваше согласие требуется перед установкой любых необязательных cookie.",
    termsCookiesNecessaryTitle: "Необходимые cookie",
    termsCookiesNecessaryContent: "Необходимы для работы сайта (безопасность, языковые настройки, согласие cookie). Не требуют вашего согласия.",
    termsCookiesAnalyticsTitle: "Аналитика (Google Analytics)",
    termsCookiesAnalyticsContent: "Google Analytics 4 помогает нам понять, как используется сайт, анонимно (IP анонимизирован). Хранение: до 14 месяцев. Данные передаются в Google LLC (США) со стандартными договорными условиями и Consent Mode v2. По умолчанию отключено до вашего согласия.",
    termsCookiesMarketingTitle: "Маркетинг",
    termsCookiesMarketingContent: "Мы не используем рекламные cookie сегодня. Категория остается доступной на будущее и всегда будет отключена по умолчанию.",
    termsCookiesRightsTitle: "Ваши права",
    termsCookiesRightsContent: "Вы имеете право на доступ, исправление, удаление, возражение и переносимость данных. Чтобы воспользоваться ими, свяжитесь с contact.applimanagement@gmail.com.",
    termsCookiesManageButton: "Изменить мои настройки cookie",
