...
const translations = {
 it: {
    ...
    geoDenied: "Geolocalizzazione bloccata — clicca sul lucchetto vicino all'URL e autorizzala.",
  ...
  en: {
    ...
    geoDenied: "Geolocation blocked — click the padlock next to the URL and allow it.",
  ...
  fr: {
    ...
    geoDenied: "Géolocalisation bloquée — clique sur le cadenas à côté de l'URL puis autorise-la.",
  ...
  de: {
    ...
    geoDenied: "Standortzugriff blockiert — klicke auf das Schloss neben der URL und erlaube es.",
  ...
  ru: {
    ...
    geoDenied: "Геолокация заблокирована — нажмите на замок рядом с адресом и разрешите её.",
