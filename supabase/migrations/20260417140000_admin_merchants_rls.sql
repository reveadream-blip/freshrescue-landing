-- FreshRescue : admins peuvent modifier / supprimer les commerçants (table public.merchants).
-- Synchroniser l’email avec src/lib/adminConfig.js et les Edge Functions.
...
-- Suppression : offres du commerçant puis ligne merchants (pas subscriptions ici : schémas variables).
...
-- Mise à jour admin (patch JSON : champs optionnels).
